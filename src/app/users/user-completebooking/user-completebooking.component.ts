...
@Component({
  selector: 'app-user-completebooking',
  templateUrl: './user-completebooking.component.html',
  styleUrls: ['./user-completebooking.component.scss']
})
export class UserCompletebookingComponent implements OnInit {
