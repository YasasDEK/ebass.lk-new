...
@Component({
  selector: 'app-shopimage',
  templateUrl: './shopimage.component.html',
  styleUrls: ['./shopimage.component.scss']
})
export class ShopimageComponent implements OnInit {
  ...
  upload(event) {
    ...
    this.afst.upload('/shopimage/' + this.randomId, event.target.files[0]);
